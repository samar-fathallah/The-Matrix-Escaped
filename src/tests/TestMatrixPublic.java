...
public class TestMatrixPublic {
	...
	public void testa1() throws Exception {
		String solution = Matrix.solve(grid1, "BF", true);
		solution = solution.replace(" ", "");
	...
	public void testa2() throws Exception {
		String solution = Matrix.solve(grid2, "BF", true);
		solution = solution.replace(" ", "");
	...
	public void testa3() throws Exception {
		String solution = Matrix.solve(grid3, "BF", true);
		solution = solution.replace(" ", "");
	...
	public void testa7() throws Exception {
		String solution = Matrix.solve(grid7, "BF", true);
		solution = solution.replace(" ", "");
	...
	public void testa8() throws Exception {
		String solution = Matrix.solve(grid8, "BF", true);
		solution = solution.replace(" ", "");
	...
	public void testa9() throws Exception {
		String solution = Matrix.solve(grid9, "BF", true);
		solution = solution.replace(" ", "");
	...
	public void testb0() throws Exception {
		String solution = Matrix.solve(grid0, "DF", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid0, solution));
	}
	...
	public void testb1() throws Exception {
		String solution = Matrix.solve(grid1, "DF", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid1, solution));
	}
	...
	public void testb2() throws Exception {
		String solution = Matrix.solve(grid2, "DF", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid2, solution));
	}
	...
	public void testb3() throws Exception {
		String solution = Matrix.solve(grid3, "DF", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid3, solution));
	}
	...
	public void testb4() throws Exception {
		String solution = Matrix.solve(grid4, "DF", true);
		assertTrue("The output actions do not lead to a goal state.", solution.equals("No Solution"));
	}
	
	@Test(timeout = 10000)
	public void testb5() throws Exception {
		String solution = Matrix.solve(grid5, "DF", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid5, solution));
	}
	...
	public void testb6() throws Exception {
		String solution = Matrix.solve(grid6, "DF", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid6, solution));
	}
	...
	public void testb7() throws Exception {
		String solution = Matrix.solve(grid7, "DF", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.",applyPlan(grid7, solution) );
	}
	...
	public void testb8() throws Exception {
		String solution = Matrix.solve(grid8, "DF", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.",applyPlan(grid8, solution));
	}
	...
	public void testb9() throws Exception {
		String solution = Matrix.solve(grid9, "DF", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid9, solution));
	}
	...
	public void testbz10() throws Exception {
		String solution = Matrix.solve(grid10, "DF", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid10, solution));
	}
	...
	public void testc0() throws Exception {
		String solution = Matrix.solve(grid0, "UC", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid0, solution));
	}
	...
	public void testc1() throws Exception {
		String solution = Matrix.solve(grid1, "UC", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid1, solution));
	}
	...
	public void testc2() throws Exception {
		String solution = Matrix.solve(grid2, "UC", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid2, solution));
	}
	...
	public void testc4() throws Exception {
		String solution = Matrix.solve(grid4, "UC", true);
		assertTrue("The output actions do not lead to a goal state.", solution.equals("No Solution"));
	}
	
	@Test(timeout = 10000)
	public void testc5() throws Exception {
		String solution = Matrix.solve(grid5, "UC", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid5, solution));
	}
	...
	public void testc6() throws Exception {
		String solution = Matrix.solve(grid6, "UC", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid6, solution));
	}
	...
	public void testc7() throws Exception {
		String solution = Matrix.solve(grid7, "UC", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.",  applyPlan(grid7, solution));
	}
	...
	public void testc8() throws Exception {
		String solution = Matrix.solve(grid8, "UC", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid8, solution));
	}
	...
	public void testc9() throws Exception {
		String solution = Matrix.solve(grid9, "UC", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid9, solution));
	}
	...
	public void testd0() throws Exception {
		String solution = Matrix.solve(grid0, "ID", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid0, solution));
	}
	...
	public void testd1() throws Exception {
		String solution = Matrix.solve(grid1, "ID", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid1, solution));
	}
	...
	public void testd2() throws Exception {
		String solution = Matrix.solve(grid2, "ID", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid2, solution));
	}
	...
	public void testd3() throws Exception {
		String solution = Matrix.solve(grid3, "ID", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid3, solution));
	}
	...
	public void testd5() throws Exception {
		String solution = Matrix.solve(grid5, "ID", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid5, solution));
	}
	...
	public void testd6() throws Exception {
		String solution = Matrix.solve(grid6, "ID", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid6, solution));
	}
	...
	public void teste0() throws Exception {
		String solution = Matrix.solve(grid0, "GR1", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid0, solution));
	}
	...
	public void teste1() throws Exception {
		String solution = Matrix.solve(grid1, "GR1", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid1, solution));
	}
	...
	public void teste2() throws Exception {
		String solution = Matrix.solve(grid2, "GR1", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid2, solution));
	}
	...
	public void teste3() throws Exception {
		String solution = Matrix.solve(grid3, "GR1", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid3, solution));
	}
	...
	public void teste4() throws Exception {
		String solution = Matrix.solve(grid4, "GR1", true);
		assertTrue("The output actions do not lead to a goal state.", solution.equals("No Solution"));
	}
	
	@Test(timeout = 10000)
	public void teste5() throws Exception {
		String solution = Matrix.solve(grid5, "GR1", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid5, solution));
	}
	...
	public void teste6() throws Exception {
		String solution = Matrix.solve(grid6, "GR1", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid6, solution));
	}
	...
	public void teste7() throws Exception {
		String solution = Matrix.solve(grid7, "GR1", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid7, solution));
	}
	...
	public void teste8() throws Exception {
		String solution = Matrix.solve(grid8, "GR1", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid8, solution));
	}
	...
	public void teste9() throws Exception {
		String solution = Matrix.solve(grid9, "GR1", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid9, solution));
	}
	...
	public void testf0() throws Exception {
		String solution = Matrix.solve(grid0, "GR2", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid0, solution));
	}
	...
	public void testf1() throws Exception {
		String solution = Matrix.solve(grid1, "GR2", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid1, solution));
	}
	...
	public void testf2() throws Exception {
		String solution = Matrix.solve(grid2, "GR2", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid2, solution));
	}
	...
	public void testf3() throws Exception {
		String solution = Matrix.solve(grid3, "GR2", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid3, solution));
	}
	...
	public void testf4() throws Exception {
		String solution = Matrix.solve(grid4, "GR2", true);
		assertTrue("The output actions do not lead to a goal state.", solution.equals("No Solution"));
	}
	
	@Test(timeout = 10000)
	public void testf5() throws Exception {
		String solution = Matrix.solve(grid5, "GR2", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid5, solution));
	}
	...
	public void testf6() throws Exception {
		String solution = Matrix.solve(grid6, "GR2", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid6, solution));
	}
	...
	public void testf7() throws Exception {
		String solution = Matrix.solve(grid7, "GR2", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid7, solution));
	}
	...
	public void testf8() throws Exception {
		String solution = Matrix.solve(grid8, "GR2", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid8, solution));
	}
	...
	public void testf9() throws Exception {
		String solution = Matrix.solve(grid9, "GR2", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid9, solution));
	}
	...
	public void testg0() throws Exception {
		String solution = Matrix.solve(grid0, "AS1", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid0, solution));
	}
	...
	public void testg1() throws Exception {
		String solution = Matrix.solve(grid1, "AS1", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid1, solution));
	}
	...
	public void testg2() throws Exception {
		String solution = Matrix.solve(grid2, "AS1", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid2, solution));
	}
	...
	public void testg4() throws Exception {
		String solution = Matrix.solve(grid4, "AS1", true);
		assertTrue("The output actions do not lead to a goal state.", solution.equals("No Solution"));
	}
	
	@Test(timeout = 10000)
	public void testg5() throws Exception {
		String solution = Matrix.solve(grid5, "AS1", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid5, solution));
	}
	...
	public void testg6() throws Exception {
		String solution = Matrix.solve(grid6, "AS1", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid6, solution));
	}
	...
	public void testg7() throws Exception {
		String solution = Matrix.solve(grid7, "AS1", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid7, solution));
	}
	...
	public void testg8() throws Exception {
		String solution = Matrix.solve(grid8, "AS1", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid8, solution));
	}
	...
	public void testg9() throws Exception {
		String solution = Matrix.solve(grid9, "AS1", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid9, solution));
	}
	...
	public void testgz10() throws Exception {
		String solution = Matrix.solve(grid10, "AS1", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid10, solution));
	}
	...
	public void testh0() throws Exception {
		String solution = Matrix.solve(grid0, "AS2", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid0, solution));
	}
	...
	public void testh1() throws Exception {
		String solution = Matrix.solve(grid1, "AS2", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid1, solution));
	}
	...
	public void testh2() throws Exception {
		String solution = Matrix.solve(grid2, "AS2", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid2, solution));
	}
	...
	public void testh4() throws Exception {
		String solution = Matrix.solve(grid4, "AS2", true);
		assertTrue("The output actions do not lead to a goal state.", solution.equals("No Solution"));
	}
	
	@Test(timeout = 10000)
	public void testh5() throws Exception {
		String solution = Matrix.solve(grid5, "AS2", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid5, solution));
	}
	...
	public void testh6() throws Exception {
		String solution = Matrix.solve(grid6, "AS2", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid6, solution));
	}
	...
	public void testh7() throws Exception {
		String solution = Matrix.solve(grid7, "AS2", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid7, solution));
	}
	...
	public void testh8() throws Exception {
		String solution = Matrix.solve(grid8, "AS2", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid8, solution));
	}
	...
	public void testh9() throws Exception {
		String solution = Matrix.solve(grid9, "AS2", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid9, solution));
	}
	...
	public void testhz10() throws Exception {
		String solution = Matrix.solve(grid10, "AS2", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid10, solution));
	}
